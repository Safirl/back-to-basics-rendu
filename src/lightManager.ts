...
export default class LightManager {
    ...
    animate(alpha: number) {
        for (let index = 0; index < this.lights.length; index++) {
            ...
            light.position.x = lerp(pointLights[index].position.x, pointLights[index].endPosition.x, alpha)
            light.position.y = lerp(pointLights[index].position.y, pointLights[index].endPosition.y, alpha)
            light.position.z = lerp(pointLights[index].position.z, pointLights[index].endPosition.z, alpha)
        }
